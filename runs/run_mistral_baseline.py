...
print("Beginning baseline Mistral Evaluation")
...
results.to_csv("./outputs/mistral_baseline_preds.csv", index=False)

rouge_score, bleu_score = evaluate_summaries(predictions=results["summary"])

save_scores("./results/mistral-baseline.pkl", rouge_score, bleu_score)
